...
test("MessageList shows friendly label for str_replace_editor create command", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
...
test("MessageList shows friendly label for file_manager delete command", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
      ...
      parts: [
        {
          ...
          toolInvocation: {
            toolCallId: "asdf",
            args: { command: "delete", path: "src/components/Old.jsx" },
